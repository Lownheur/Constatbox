...
\begin{titlepage}
    ...
    {\Huge \textbf{\color{policeBlue}CHARTE DE PROJET}}\\[0.5cm]
    {\Huge \textbf{CONSTAT BOX}}\\[0.5cm]
    
    \includegraphics[width=0.7\textwidth]{equipe.jpg}\\[1cm]
    
    {\Large \textbf{Version :} 2.1}\\[0.5cm]
    ...
    \textit{Bruno, Etienne, Marc, Gina, Teddy}
\end{titlepage}
